		...
		return (
			<div style={{ flexGrow: 1 }}>
				...
				<Container style={{ paddingTop: 20, marginBottom: 96 }}>
					<strong>Privacy Policy</strong> <p>Evan Trowbridge built the Giftamizer app as a Free app. This SERVICE is provided by Evan Trowbridge at no cost and is intended for use as is.</p>
					...
					<p>
						The terms used in this Privacy Policy have the same meanings as in our <Link to={'/terms'}>Terms and Conditions</Link>, which is accessible at Giftamizer unless otherwise
					...
					<p>
						For a better experience, while using our Service, I may require you to provide us with certain personally identifiable information, including but not limited to your name,
						email address, images(group and account cards), personal data(gift ideas).
					</p>
					<div>
					...
					<p>
						I want to inform you that whenever you use my Service, in a case of an error in the app I collect data and information (through third party products) on your phone called Log
					...
					<p>
						I want to inform users of this Service that these third parties have access to your Personal Information. The reason is to perform the tasks assigned to them on our behalf.
					...
					<p>
						These Services do not address anyone under the age of 13. I do not knowingly collect personally identifiable information from children under 13. In the case I discover that a
					...
					<p>
						I may update our Privacy Policy from time to time. Thus, you are advised to review this page periodically for any changes. I will notify you of any changes by posting the new
						Privacy Policy on this page.
					</p>
					<p>This policy is effective as of 12/01/2020</p>
					<p>
						<strong>Contact Us</strong>
					</p>
					<p>If you have any questions or suggestions about my Privacy Policy, do not hesitate to contact me at evan@trowbridge.tech.</p>
				</Container>
			</div>
		);
	}
